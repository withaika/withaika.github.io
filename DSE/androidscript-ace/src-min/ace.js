...
define("ace/mouse/mouse_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/mouse/default_handlers", "ace/mouse/default_gutter_handler", "ace/mouse/mouse_event", "ace/mouse/dragdrop_handler", "ace/config"], function(e, t, n) {
    ...
    var r = e("../lib/event")
      ...
      , l = function(e) {
        ...
        e.renderer.scrollBarV && (r.addMultiMouseDownListener(e.renderer.scrollBarV.inner, [400, 300, 250], this, "onMouseEvent"),
        r.addMultiMouseDownListener(e.renderer.scrollBarH.inner, [400, 300, 250], this, "onMouseEvent"),
        i.isIE && (r.addListener(e.renderer.scrollBarV.element, "mousedown", n),
            ...
            if (t.action === "insertText")
                if (s.row === r && s.column <= i) {
                    if (s.column !== i || !this.$insertRight)
                        s.row === o.row ? i += o.column - s.column : (i -= s.column,
                        r += o.row - s.row)
                } else
                    s.row !== o.row && s.row < r && (r += o.row - s.row);
            else
                t.action === "insertLines" ? (s.row !== r || i !== 0 || !this.$insertRight) && s.row <= r && (r += o.row - s.row) : t.action === "removeText" ? s.row === r && s.column < i ? o.column >= i ? i = s.column : i = Math.max(0, i - (o.column - s.column)) : s.row !== o.row && s.row < r ? (o.row === r && (i = Math.max(0, i - o.column) + s.column),
    ...
    (function() {
        ...
        this.$onChange = function(e) {
            ...
            for (var f = 0, l = a.length; f < l; f++) {
                ...
                if (c.start.row > i)
                    break;
                c.start.row == i && c.start.column >= n.column && (c.start.column != n.column || !this.$insertRight) && (c.start.column += u,
                c.start.row += o);
...
define("ace/keyboard/hash_handler", ["require", "exports", "module", "ace/lib/keys", "ace/lib/useragent"], function(e, t, n) {
    ...
    function() {
        ...
        this._addCommandToBinding = function(e, t, n) {
            ...
            t ? !r[e] || this.$singleCommand ? r[e] = t : (Array.isArray(r[e]) ? (i = r[e].indexOf(t)) != -1 && r[e].splice(i, 1) : r[e] = [r[e]],
            n || t.isDefault ? r[e].unshift(t) : r[e].push(t)) : delete r[e]
        }
        ,
...
define("ace/layer/marker", ["require", "exports", "module", "ace/range", "ace/lib/dom"], function(e, t, n) {
    ...
    (function() {
        ...
        this.drawTextMarker = function(e, t, n, i, s) {
            var o = t.start.row
              , u = this.session
              , a = new r(o,t.start.column,o,u.getScreenLastRowColumn(o));
            this.drawSingleLineMarker(e, a, n + " ace_start", i, 1, s),
            o = t.end.row,
            a = new r(o,u.getRowWrapIndent(o),o,t.end.column),
            this.drawSingleLineMarker(e, a, n, i, 0, s);
            for (o = t.start.row + 1; o < t.end.row; o++)
                a.start.row = o,
                a.start.column = u.getRowWrapIndent(o),
                a.end.row = o,
                a.end.column = u.getScreenLastRowColumn(o),
                this.drawSingleLineMarker(e, a, n, i, 1, s)
        }
        ,
...
define("ace/virtual_renderer", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/config", "ace/lib/useragent", "ace/layer/gutter", "ace/layer/marker", "ace/layer/text", "ace/layer/cursor", "ace/scrollbar", "ace/scrollbar", "ace/renderloop", "ace/layer/font_metrics", "ace/lib/event_emitter"], function(e, t, n) {
    ...
    (function() {
        ...
        this.scrollCursorIntoView = function(e, t, n) {
            ...
            a + o > s ? (t && (s -= t * this.$size.scrollerHeight),
            s === 0 && (s = -this.scrollMargin.top),
            this.session.setScrollTop(s)) : a + this.$size.scrollerHeight - u < s + this.lineHeight && (t && (s += t * this.$size.scrollerHeight),
...
define("ace/line_widgets", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/range"], function(e, t, n) {
    ...
    (function() {
        ...
        this.addLineWidget = function(e) {
            ...
            return e.html && !e.el && (e.el = i.createElement("div"),
